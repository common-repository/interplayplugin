 ...
 * 
 */
class org_interplay_wordpress_performingGroup_service
...
implements com_ajmichels_wppf_interface_iService
{
	...
	public function getPerformingGroups ()
	{
		$this->setData();
	...
	private function setData ()
	{
		...
		$wsu->setScriptPath( 'PerformingGroupService.cfc' );
		$wsu->setParameter( 'method', 'getPerformingGroupsRemotely' );
		...
		$dao->setData( $data['performingGroups'] );
