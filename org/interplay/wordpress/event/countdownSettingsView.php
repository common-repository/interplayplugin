 ...
 * @title         countdownSettingsView.php
 ...
 * 
 */
class org_interplay_wordpress_event_countdownSettingsView
...
implements com_ajmichels_wppf_interface_iView
{
	...
	{
		$this->setTemplate( dirname( __FILE__ ) . '\template\countdownSettings.php' );
	}
